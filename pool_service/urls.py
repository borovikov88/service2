...
from .finance_views import (
    ...
    finance_onec_odata_profit_draft,
    finance_onec_odata_cashflow_draft,
    finance_onec_odata_sync_start,
    finance_onec_odata_sync_reactivate,
    ...
    finance_onec_cashflow_mapping,
    finance_onec_cashflow_mapping_save,
    ...
    finance_payroll_import_list,
    finance_payroll_accrual_fetch,
    finance_payroll_accrual_preview,
    finance_payroll_import_upload,
    finance_payroll_import_preview,
...
from .employee_reward_views import (
    reward_adjustment_confirm,
    reward_adjustment_create,
    reward_assignment_save,
    reward_author_map,
    reward_author_mapping,
    reward_confirm,
    reward_confirmation_preview,
    reward_dashboard,
    reward_document,
    reward_employee_detail,
    reward_month_close,
    reward_rule_version_create,
    reward_rules,
)
...
urlpatterns = [
    ...
    path("finance/operations/", finance_operations, name="finance_operations"),
    path("finance/overview/", finance_overview, name="finance_overview"),
    path("finance/my/", finance_my, name="finance_my"),
    ...
    path("finance/1c-imports/odata/sync/start/", finance_onec_odata_sync_start, name="finance_onec_odata_sync_start"),
    path("finance/1c-imports/odata/sync/<uuid:run_id>/step/", finance_onec_odata_sync_step, name="finance_onec_odata_sync_step"),
    path("finance/1c-imports/odata/sync/<uuid:run_id>/reactivate/", finance_onec_odata_sync_reactivate, name="finance_onec_odata_sync_reactivate"),
    path("finance/1c-imports/odata/sync/<uuid:run_id>/", finance_onec_odata_sync_status, name="finance_onec_odata_sync_status"),
    path("finance/1c-imports/odata/refresh-apply/start/", finance_onec_refresh_apply_start, name="finance_onec_refresh_apply_start"),
    path("finance/1c-imports/odata/refresh-apply/<uuid:run_id>/step/", finance_onec_refresh_apply_step, name="finance_onec_refresh_apply_step"),
    path("finance/1c-imports/odata/refresh-apply/<uuid:run_id>/status/", finance_onec_refresh_apply_status, name="finance_onec_refresh_apply_status"),
    path("finance/1c-imports/odata/refresh-apply/<uuid:run_id>/", finance_onec_refresh_apply_detail, name="finance_onec_refresh_apply_detail"),
    path("finance/1c-imports/odata/draft/", finance_onec_odata_profit_draft, name="finance_onec_odata_profit_draft"),
    path("finance/1c-imports/odata/cashflow/draft/", finance_onec_odata_cashflow_draft, name="finance_onec_odata_cashflow_draft"),
    path("finance/1c-imports/cashflow/<uuid:batch_id>/preview/", finance_onec_cashflow_preview, name="finance_onec_cashflow_preview"),
    path("finance/1c-imports/cashflow/<uuid:batch_id>/confirm/", finance_onec_cashflow_confirm, name="finance_onec_cashflow_confirm"),
    path("finance/1c-imports/cashflow/<uuid:batch_id>/cancel/", finance_onec_cashflow_cancel, name="finance_onec_cashflow_cancel"),
    path("finance/1c-imports/cashflow/<uuid:batch_id>/", finance_onec_cashflow_detail, name="finance_onec_cashflow_detail"),
    path("finance/1c-cashflow/", finance_onec_cashflow_dashboard, name="finance_onec_cashflow_dashboard"),
    ...
    path("finance/rewards/", reward_dashboard, name="finance_rewards"),
    path("finance/rewards/staff/<int:employee_id>/", reward_employee_detail, name="finance_reward_employee_detail"),
    path("finance/rewards/document/<str:document_type>/<uuid:document_guid>/", reward_document, name="finance_reward_document"),
    path("finance/rewards/document/<str:document_type>/<uuid:document_guid>/assign/", reward_assignment_save, name="finance_reward_assignment_save"),
    path("finance/rewards/confirm-preview/", reward_confirmation_preview, name="finance_reward_confirmation_preview"),
    path("finance/rewards/confirm/", reward_confirm, name="finance_reward_confirm"),
    path("finance/rewards/authors/", reward_author_mapping, name="finance_reward_author_mapping"),
    path("finance/rewards/authors/<int:identity_id>/map/", reward_author_map, name="finance_reward_author_map"),
    path("finance/rewards/rules/", reward_rules, name="finance_reward_rules"),
    path("finance/rewards/rules/new-version/", reward_rule_version_create, name="finance_reward_rule_version_create"),
    path("finance/rewards/close/", reward_month_close, name="finance_reward_month_close"),
    path("finance/rewards/adjustments/new/", reward_adjustment_create, name="finance_reward_adjustment_create"),
    path("finance/rewards/adjustments/<int:adjustment_id>/confirm/", reward_adjustment_confirm, name="finance_reward_adjustment_confirm"),
    ...
    path("finance/payroll/", finance_payroll_dashboard, name="finance_payroll_dashboard"),
    path("finance/payroll/plan/refresh/", finance_payroll_plan_refresh, name="finance_payroll_plan_refresh"),
    path("finance/payroll/accrual/fetch/", finance_payroll_accrual_fetch, name="finance_payroll_accrual_fetch"),
    path("finance/payroll/accrual/<uuid:batch_id>/", finance_payroll_accrual_preview, name="finance_payroll_accrual_preview"),
    path("finance/payroll/import/", finance_payroll_import_list, name="finance_payroll_import_list"),
    path("finance/payroll/import/upload/", finance_payroll_import_upload, name="finance_payroll_import_upload"),
