...
GITHUB_DEVELOPMENT_REVIEW_TOKEN = os.getenv("GITHUB_DEVELOPMENT_REVIEW_TOKEN", "")
GITHUB_DEVELOPMENT_REVIEW_LOGIN = os.getenv("GITHUB_DEVELOPMENT_REVIEW_LOGIN", "")
GITHUB_DEVELOPMENT_AUTO_MERGE_ENABLED = _env_bool(
...
ONEC_ODATA_PAYROLL_CURRENCY_CODE = os.getenv("ONEC_ODATA_PAYROLL_CURRENCY_CODE", "")
ONEC_ODATA_PAYROLL_CURRENCY_GUID = os.getenv("ONEC_ODATA_PAYROLL_CURRENCY_GUID", "")
ONEC_ODATA_PAYROLL_AUTO_COVERAGE_GUIDS = os.getenv("ONEC_ODATA_PAYROLL_AUTO_COVERAGE_GUIDS", "")
# The worker is opt-in; its clock is independent of the browser/server timezone.
ONEC_FINANCE_DAILY_ENABLED = _env_bool("ONEC_FINANCE_DAILY_ENABLED", False)
ONEC_FINANCE_SYNC_USER_ID = os.getenv("ONEC_FINANCE_SYNC_USER_ID", "")
ONEC_FINANCE_DAILY_TIME = os.getenv("ONEC_FINANCE_DAILY_TIME", "06:00")
ONEC_FINANCE_TIME_ZONE = os.getenv("ONEC_FINANCE_TIME_ZONE", "Asia/Barnaul")
SERVICE_TIME_ZONE = os.getenv("SERVICE_TIME_ZONE", "Asia/Barnaul")
